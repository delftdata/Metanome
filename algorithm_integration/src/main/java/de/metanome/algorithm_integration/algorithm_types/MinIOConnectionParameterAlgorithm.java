...
/**
 * An {@link Algorithm} that takes {@link MinIOConnectionGenerator}
 * configuration values.
 *
 * @author Jakob Zwiener
 */
public interface MinIOConnectionParameterAlgorithm extends Algorithm {
   ...
   * @throws AlgorithmConfigurationException if the algorithm
   *                                                                           cannot be correctly
   *                                                                           configured using the
   *                                                                           received configuration
   *                                                                           values
   */
  void setMinIOConnectionGeneratorConfigurationValue(String identifier,
