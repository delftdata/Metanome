...
/**
 * An {@link Algorithm} that takes {@link MinIOInputGenerator}
 * configuration values.
 *
 * @author Jakob Zwiener
 */
public interface MinIOInputParameterAlgorithm extends Algorithm {

  /**
   * Sets a {@link TableInputGenerator} configuration value
   * on the algorithm.
   *
   ...
   */
  void setMinIOInputConfigurationValue(String identifier, MinIOInputGenerator... values)
